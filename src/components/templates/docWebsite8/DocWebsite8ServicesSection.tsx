...
interface DocWebsite8ServicesSectionProps {
  clinic: Clinic;
}

export const DocWebsite8ServicesSection: React.FC<
  DocWebsite8ServicesSectionProps
> = ({ clinic }) => {
...
export default DocWebsite8ServicesSection;
