...
interface DocWebsite7ServicesSectionProps {
  clinic: Clinic;
}

export const DocWebsite7ServicesSection: React.FC<
  DocWebsite7ServicesSectionProps
> = ({ clinic }) => {
  return (
    <Box
      id="services"
...
export default DocWebsite7ServicesSection;
