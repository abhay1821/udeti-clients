...
interface CircularImageServicesSectionProps {
  clinic: Clinic;
}

const CircularImageServicesSectionComponent: React.FC<
  CircularImageServicesSectionProps
> = ({ clinic }) => {
...
export const CircularImageServicesSection = React.memo(
  CircularImageServicesSectionComponent,
  (prevProps, nextProps) => {
    return prevProps.clinic.id === nextProps.clinic.id;
  }
);

export default CircularImageServicesSection;
